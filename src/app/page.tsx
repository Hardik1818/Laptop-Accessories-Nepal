      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 pt-8 pb-12 md:pt-16 space-y-20 md:space-y-32">
        ...
        <section className="animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
          <div className="flex items-end justify-between mb-8 md:mb-12">
            <div className="space-y-1">
              <h2 className="text-2xl md:text-5xl font-black text-foreground tracking-tighter uppercase italic">
                Trending <span className="text-primary">NOW</span>
              </h2>
              <div className="h-1 w-12 bg-primary rounded-full" />
            </div>
            <Link href="/shop" className="group flex items-center gap-1 text-xs md:text-sm font-bold text-muted-foreground hover:text-primary transition-colors uppercase tracking-widest">
        ...
        <section className="animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-500">
          <div className="flex items-end justify-between mb-8 md:mb-12 text-right">
            <Link href="/shop" className="group hidden sm:flex items-center gap-1 text-xs md:text-sm font-bold text-muted-foreground hover:text-primary transition-colors uppercase tracking-widest order-1">
            ...
            <div className="space-y-1 sm:order-2">
              <h2 className="text-2xl md:text-5xl font-black text-foreground tracking-tighter uppercase italic">
                <span className="text-gradient-premium">New</span> Arrivals
              </h2>
              <div className="h-1 w-12 bg-primary rounded-full ml-auto" />
            </div>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-8">
          ...
          <div className="mt-8 sm:hidden text-center">
            <Link href="/shop" className="inline-flex items-center gap-2 text-xs font-bold text-muted-foreground hover:text-primary transition-colors uppercase tracking-widest">
